...
use crate::vulkan::objects::{get_required_device_extensions, get_wanted_device_extensions};
...
pub unsafe fn get_physical_device(
    ...
    let devices = instance
        ...
        .map_err(GraphicsError::EnumeratePhysicalDevicesError)?;

    if devices.is_empty() {
        return Err(GraphicsError::EnumeratePhysicalDevicesError(
