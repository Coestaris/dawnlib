...
impl Shader {
    pub fn new_from_file(
        ...
        let mut file = std::fs::File::open(file_path)
            .map_err(|e| GraphicsError::ShaderFileReadError(e.to_string()))?;
        let data = ash::util::read_spv(&mut file)
            .map_err(|e| GraphicsError::ShaderValidationError(e.to_string()))?;
        ...
        let vk_shader_module = unsafe {
            device
                ...
                .map_err(GraphicsError::ShaderModuleCreateError)?
        };
