...
pub unsafe fn avx512_block_m32(input: &PlanarBlock<f32>, output: &mut PlanarBlock<f32>) {
...
pub unsafe fn neon_block_m4(input: &PlanarBlock<f32>, output: &mut PlanarBlock<f32>) {
...
pub unsafe fn avx_block_m32(input: &PlanarBlock<f32>, output: &mut PlanarBlock<f32>) {
    use core::arch::x86_64::*;
    todo!();
}
...
pub unsafe fn sse42_block_m32(input: &PlanarBlock<f32>, output: &mut PlanarBlock<f32>) {
    use core::arch::x86_64::*;
