...
//
//   .manifest.toml - file with all resources in the archive and their hashes (generated by the packager)
...
//
// Resource.toml - metadata file for the resource. It contains of two parts:
//   - Header - contains the name, tag, type, checksum, and other metadata.
//     For available types see structure `ResourceHeader`.
