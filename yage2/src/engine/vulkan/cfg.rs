...
pub const VALIDATION_LAYER_NAME: *const c_char =
    unsafe { CStr::from_bytes_with_nul_unchecked(b"VK_LAYER_KHRONOS_validation\0") }.as_ptr()
        as *const c_char;
pub const SURFACE_EXTENSION_NAME: *const c_char = ash::khr::surface::NAME.as_ptr() as *const c_char;
pub const SWAPCHAIN_EXTENSION_NAME: *const c_char =
    ash::khr::swapchain::NAME.as_ptr() as *const c_char;
pub const DYNAMIC_RENDERING_EXTENSION_NAME: *const c_char =
    ash::khr::dynamic_rendering::NAME.as_ptr() as *const c_char;
pub const SYNCHRONIZATION_2_EXTENSION_NAME: *const c_char =
